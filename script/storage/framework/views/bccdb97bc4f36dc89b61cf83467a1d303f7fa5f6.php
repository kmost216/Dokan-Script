          ...
          <section class="mt-50 mb-50">
            <div class="requirments-section">
              ...
              if ($info['phpversion'] >= 7.3 && $info['mbstring'] == 1 && $info['bcmath'] == 1 && $info['ctype'] == 1 && $info['json'] == 1 && $info['openssl'] == 1 && $info['pdo'] == 1 && $info['tokenizer'] == 1 && $info['xml'] == 1 && $info['fileinfo'] == 1 && $info['allow_url_fopen'] == 1) { ?>
                <a href="info" class="btn btn-primary install-btn f-right"><?php echo e(__('Next')); ?></a>
                <?php
              }else{ ?>
...
<?php /**PATH D:\Work\dokan\Dokan\files\script\resources\views/installer/requirments.blade.php ENDPATH**/ ?>